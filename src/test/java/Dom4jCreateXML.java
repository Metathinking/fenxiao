...
//        createMapper(HomeImage.class,directoryPath,Arrays.asList(INSERT,UPDATE,DELETE,LIST,GET_COUNT,GET_MAX_ID,FIND_BY_ID));
        createMapper(Notice.class,directoryPath,Arrays.asList(INSERT,UPDATE,DELETE,LIST,GET_COUNT,GET_MAX_ID,FIND_BY_ID));
    }
    ...
    private static String testDirectoryPath = "G:" + File.separator + "workspace" + File.separator + "fenxiao" + File.separator + "src" + File.separator + "test" + File.separator
