...
<header class="container-fluid mine_header">
    <div class="row">
        <div class="col-xs-2 text-center">
            <img src="static/images/tou.png" class="mine_header_img"/>
        </div>
        <div class="col-xs-8">
            <h2>会员名称</h2>
            <p>VIP会员</p>
...
<div class="container-fluid">
    <a href="" >
        <div class="row mine_item" style="margin-top: 5%;">
            ...
            <div class="col-xs-10">余额：<span style="color: #9f3025">￥300</span></div>
